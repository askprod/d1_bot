// // Check if node is valid chat element
...
//   // Set interval to disconnect and reconnect the observer every 30 seconds in case something goes wrong
//   setInterval(() => {
...
// // Initialize observer
// const initializeObserver = (chatContainer) => {
...
//               window.lastNodeDetails = node_details;
...
// // Wrapper to invoke the script from driver.execute_script in the ruby code
// ((chatContainer) => {
